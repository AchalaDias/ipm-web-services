...
class PHPMailer {
   ...
   * @var string
   */
  public $From              = 'misreports@hnbassurance.com';
   ...
   * @var string
   */
  public $Host          = 'smtp.hnbassurance.com';
   ...
   * @var string
   */
  public $Username      = 'misreports';

  /**
   * Sets SMTP password.
   * @var string
   */
  public $Password      = 'Water@1234';
...
class phpmailerException extends Controller {
